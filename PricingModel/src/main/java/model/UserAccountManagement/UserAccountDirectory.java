...
public class UserAccountDirectory {
    ...
    public UserAccount newUserAccount(Profile p, String userAccount, String passWord, String companyName) {
        UserAccount ua = new UserAccount (p,  userAccount,  passWord,companyName);
